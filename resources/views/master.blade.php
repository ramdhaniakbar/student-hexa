      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
         <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            {{-- <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('assets/images/logo.svg') }}"
                  alt="logo" /></a> --}}
            <a class="sidebar-brand brand-logo text-white" style="text-decoration: none" href="">Student Hexa</a>
            {{-- <a class="sidebar-brand brand-logo-mini" href="index.html"><img
                  src="{{ asset('assets/images/logo-mini.svg') }}" alt="logo" /></a> --}}
            <a class="sidebar-brand brand-logo-mini text-white" style="text-decoration: none" href="">CSH</a>
         </div>
         <ul class="nav">
            ...
            <li class="menu-items {{ request()->is('teacher/dashboard') ? 'nav-item' : '' }}">
               <a class="nav-link" href="/teacher/dashboard">
                  <span class="menu-icon">
                     <i class="mdi mdi-account"></i>
                  </span>
                  <span class="menu-title">Student Users</span>
               </a>
            </li>
            @endif
